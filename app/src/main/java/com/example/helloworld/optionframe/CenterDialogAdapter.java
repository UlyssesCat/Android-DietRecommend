package com.example.helloworld.optionframe;
...
public class CenterDialogAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (position == 0) {
            viewHolder.tv_dialog.setBackgroundResource(R.drawable._picker_item_dialog_selector_top);
        } else if (position == getCount() - 1) {
            viewHolder.tv_dialog.setBackgroundResource(R.drawable._picker_item_dialog_selector_bottom);
        } else {
            viewHolder.tv_dialog.setBackgroundResource(R.drawable._picker_item_dialog_selector);
        }
