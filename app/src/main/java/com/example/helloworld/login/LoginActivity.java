    ...
    Runnable runnable=new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                con =DriverManager.getConnection("jdbc:mysql://10.132.89.30:3306/db", "root", "19981025");
...
//                        DriverManager.getConnection("jdbc:mysql://http://192.168.1.100/phpmyadmin/index.php:8086/b2b",
//                                UserName, Password);
                    String sql="select * from login where id ='" + getAccount()  + "' and password ='" + getPassword() + "'";
